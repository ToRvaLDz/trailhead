---
title: Hooks
description: The commit guard, secret guard, install guard, and injection scanner that enforce trailhead's discipline.
---

Beyond the skill's instructions, trailhead ships four of its own hooks (self-contained, installed alongside the plugin) that *enforce* the parts of the discipline the model shouldn't be trusted to remember:
