...
- **Out of scope**: what's been ruled out; flag any line that looks **deferred** (waits on something outside the map, not truly beyond the destination) as an advisory to re-route it (seed/idea/todo), see [Out of scope](#out-of-scope).
