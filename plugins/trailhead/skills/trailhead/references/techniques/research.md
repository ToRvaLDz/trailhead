# Research
Spawn a focused subagent (AFK, parallelisable) with exactly ONE clear question — sharp enough that the answer is a decision, not a survey. Vague scope breeds rabbit holes; a narrow question is its own leash.
